...
public class Game implements MouseHandler {
    ...
    public Game() {
        ...
        player = new Player(630, 620, Utilities.PREFIX + "PlayerBlue.png", "Fred");
    ...
    public void addPlayer() {
        executorService.execute(() -> {
            if (!hasStarted) {
                if (playerCount == 1) {
                    player1 = new Player(630, 620, Utilities.PREFIX + "PlayerGold.png", "Bernardo");
                    text.delete();
                    ...
                    player2 = new Player(630, 620, Utilities.PREFIX + "PlayerGreen.png", "Alex");
                    text.delete();
                    ...
                    player3 = new Player(630, 620, Utilities.PREFIX + "PlayerWhite.png", "Rúben");
                    text.delete();
