...
public class SimpleGfxGrid implements Grid {
    ...
    public SimpleGfxGrid(int cols, int rows){
        this.cols = cols;
        this.rows = rows;
        rectangle = new Rectangle(PADDING, PADDING, cell * cols, cell * rows);
    }
    ...
    /**
     * Obtains the grid X position in the SimpleGFX canvas (É o meu retangulo)
